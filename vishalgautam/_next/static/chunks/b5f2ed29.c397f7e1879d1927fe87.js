            ...
            function (e, t, r) {
                ...
                u = (function () {
                  function e(e) {
                    (this.displayMode = void 0),
                      ...
                      (e = e || {}),
                      (this.displayMode = c.deflt(e.displayMode, !1)),
                      (this.output = c.deflt(e.output, "htmlAndMathml")),
                      (this.leqno = c.deflt(e.leqno, !1)),
                      (this.fleqn = c.deflt(e.fleqn, !1)),
                      (this.throwOnError = c.deflt(e.throwOnError, !0)),
                      (this.errorColor = c.deflt(e.errorColor, "#cc0000")),
                      (this.macros = e.macros || {}),
                      (this.minRuleThickness = Math.max(
                        0,
                        c.deflt(e.minRuleThickness, 0)
                      )),
                      (this.colorIsTextColor = c.deflt(e.colorIsTextColor, !1)),
                      (this.strict = c.deflt(e.strict, "warn")),
                      (this.trust = c.deflt(e.trust, !1)),
                      (this.maxSize = Math.max(0, c.deflt(e.maxSize, 1 / 0))),
                      (this.maxExpand = Math.max(0, c.deflt(e.maxExpand, 1e3))),
                      (this.globalGroup = c.deflt(e.globalGroup, !1));
                  }
                  var t = e.prototype;
                  return (
                    ...
                    (t.isTrusted = function (e) {
                      e.url &&
                        !e.protocol &&
                        (e.protocol = c.protocolFromUrl(e.url));
                      var t =
              ...
              var z = 80,
                ...
                q = function (e) {
                  ...
                  for (var r in ((t.className = B(this.classes)), this.style))
                ...
                N = function (e) {
                  var t = "<" + e;
                  this.classes.length &&
                    (t += ' class="' + c.escape(B(this.classes)) + '"');
                  var r = "";
                  for (var n in this.style)
                    this.style.hasOwnProperty(n) &&
                      (r += c.hyphenate(n) + ":" + this.style[n] + ";");
                  for (var a in (r && (t += ' style="' + c.escape(r) + '"'),
                  this.attributes))
                  ...
                  return (
                    ...
                    (t.toMarkup = function () {
                      ...
                      for (var r in this.style)
                        this.style.hasOwnProperty(r) &&
                          (t += c.hyphenate(r) + ":" + this.style[r] + ";");
                      return (
                        t && (e += ' style="' + c.escape(t) + '"'), (e += "'/>")
                      );
                    }),
                    e
                  );
                  ...
                  return (
                    ...
                    (t.toNode = function () {
                      ...
                      this.classes.length > 0 &&
                        ((t = t || document.createElement("span")).className =
                          B(this.classes)),
                      this.style))
                        this.style.hasOwnProperty(r) &&
              ...
              function Y(e, t, r) {
                ...
                if (
                  (!a &&
                    e[0] in G &&
                    ((n = G[e[0]].charCodeAt(0)), (a = V[t][n])),
                  a || "text" !== r || (M(n) && (a = V[t][77])),
                  a)
                )
                  return {
                    depth: a[0],
              ...
              var _ = {},
                W = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
                X = {
                  "accent-token": 1,
                  mathord: 1,
                  "op-token": 1,
              ...
              function Z(e, t, r, n, a, i) {
                (j[e][a] = { font: t, group: r, replace: n }),
                  i && n && (j[e][n] = j[e][a]);
              }
              var K = "math",
                J = "text",
              ...
              Z(K, Q, he, "\u2261", "\\equiv", !0),
                ...
                Z(K, Q, he, "\u22c8", "\\bowtie", !0),
                Z(K, Q, he, "\u2323", "\\smile", !0),
                Z(K, Q, he, "\u2291", "\\sqsubseteq", !0),
                Z(K, Q, he, "\u2292", "\\sqsupseteq", !0),
                Z(K, Q, he, "\u2250", "\\doteq", !0),
                Z(K, Q, he, "\u2322", "\\frown", !0),
                Z(K, Q, he, "\u220b", "\\ni", !0),
                Z(K, Q, he, "\u221d", "\\propto", !0),
                ...
                Z(K, Q, ce, "\u2118", "\\wp", !0),
                Z(K, Q, ce, "\u266f", "\\sharp", !0),
                Z(K, Q, ce, "\u2662", "\\diamondsuit", !0),
                Z(K, Q, ce, "\u211c", "\\Re", !0),
                Z(K, Q, ce, "\u2661", "\\heartsuit", !0),
                Z(K, Q, ce, "\u2111", "\\Im", !0),
                Z(K, Q, ce, "\u2660", "\\spadesuit", !0),
                Z(J, Q, ce, "\xa7", "\\S", !0),
                Z(J, Q, ce, "\xb6", "\\P", !0),
                Z(K, Q, ce, "\u2020", "\\dag"),
                Z(J, Q, ce, "\u2020", "\\dag"),
                ...
                Z(K, Q, ce, "\u2021", "\\ddag"),
                Z(J, Q, ce, "\u2021", "\\ddag"),
                Z(J, Q, ce, "\u2021", "\\textdaggerdbl"),
                Z(K, Q, ne, "\u23b1", "\\rmoustache", !0),
                Z(K, Q, se, "\u23b0", "\\lmoustache", !0),
                Z(K, Q, ne, "\u27ef", "\\rgroup", !0),
                Z(K, Q, se, "\u27ee", "\\lgroup", !0),
                Z(K, Q, re, "\u2213", "\\mp", !0),
                Z(K, Q, re, "\u2296", "\\ominus", !0),
                ...
                Z(K, Q, re, "\u2a3f", "\\amalg"),
                Z(K, Q, re, "&", "\\And"),
                Z(K, Q, he, "\u27f5", "\\longleftarrow", !0),
                Z(K, Q, he, "\u21d0", "\\Leftarrow", !0),
                Z(K, Q, he, "\u27f8", "\\Longleftarrow", !0),
                Z(K, Q, he, "\u27f6", "\\longrightarrow", !0),
                Z(K, Q, he, "\u21d2", "\\Rightarrow", !0),
                Z(K, Q, he, "\u27f9", "\\Longrightarrow", !0),
                Z(K, Q, he, "\u2194", "\\leftrightarrow", !0),
                Z(K, Q, he, "\u27f7", "\\longleftrightarrow", !0),
                Z(K, Q, he, "\u21d4", "\\Leftrightarrow", !0),
                Z(K, Q, he, "\u27fa", "\\Longleftrightarrow", !0),
                Z(K, Q, he, "\u21a6", "\\mapsto", !0),
                Z(K, Q, he, "\u27fc", "\\longmapsto", !0),
                Z(K, Q, he, "\u2197", "\\nearrow", !0),
                Z(K, Q, he, "\u21a9", "\\hookleftarrow", !0),
                Z(K, Q, he, "\u21aa", "\\hookrightarrow", !0),
                Z(K, Q, he, "\u2198", "\\searrow", !0),
                Z(K, Q, he, "\u21bc", "\\leftharpoonup", !0),
                Z(K, Q, he, "\u21c0", "\\rightharpoonup", !0),
                Z(K, Q, he, "\u2199", "\\swarrow", !0),
                Z(K, Q, he, "\u21bd", "\\leftharpoondown", !0),
                Z(K, Q, he, "\u21c1", "\\rightharpoondown", !0),
                Z(K, Q, he, "\u2196", "\\nwarrow", !0),
                Z(K, Q, he, "\u21cc", "\\rightleftharpoons", !0),
                Z(K, ee, he, "\u226e", "\\nless", !0),
                Z(K, ee, he, "\ue010", "\\@nleqslant"),
                Z(K, ee, he, "\ue011", "\\@nleqq"),
                Z(K, ee, he, "\u2a87", "\\lneq", !0),
                ...
                Z(K, ee, he, "\ue00c", "\\@lvertneqq"),
                Z(K, ee, he, "\u22e6", "\\lnsim", !0),
                Z(K, ee, he, "\u2a89", "\\lnapprox", !0),
                Z(K, ee, he, "\u2280", "\\nprec", !0),
                Z(K, ee, he, "\u22e0", "\\npreceq", !0),
                Z(K, ee, he, "\u22e8", "\\precnsim", !0),
                Z(K, ee, he, "\u2ab9", "\\precnapprox", !0),
                Z(K, ee, he, "\u2241", "\\nsim", !0),
                Z(K, ee, he, "\ue006", "\\@nshortmid"),
                Z(K, ee, he, "\u2224", "\\nmid", !0),
                Z(K, ee, he, "\u22ac", "\\nvdash", !0),
                ...
                Z(K, ee, he, "\u22ea", "\\ntriangleleft"),
                Z(K, ee, he, "\u22ec", "\\ntrianglelefteq", !0),
                Z(K, ee, he, "\u228a", "\\subsetneq", !0),
                Z(K, ee, he, "\ue01a", "\\@varsubsetneq"),
                Z(K, ee, he, "\u2acb", "\\subsetneqq", !0),
                Z(K, ee, he, "\ue017", "\\@varsubsetneqq"),
                Z(K, ee, he, "\u226f", "\\ngtr", !0),
                Z(K, ee, he, "\ue00f", "\\@ngeqslant"),
                Z(K, ee, he, "\ue00e", "\\@ngeqq"),
                Z(K, ee, he, "\u2a88", "\\gneq", !0),
                ...
                Z(K, ee, he, "\ue00d", "\\@gvertneqq"),
                Z(K, ee, he, "\u22e7", "\\gnsim", !0),
                Z(K, ee, he, "\u2a8a", "\\gnapprox", !0),
                Z(K, ee, he, "\u2281", "\\nsucc", !0),
                Z(K, ee, he, "\u22e1", "\\nsucceq", !0),
                Z(K, ee, he, "\u22e9", "\\succnsim", !0),
                Z(K, ee, he, "\u2aba", "\\succnapprox", !0),
                Z(K, ee, he, "\u2246", "\\ncong", !0),
                Z(K, ee, he, "\ue007", "\\@nshortparallel"),
                Z(K, ee, he, "\u2226", "\\nparallel", !0),
                Z(K, ee, he, "\u22af", "\\nVDash", !0),
                Z(K, ee, he, "\u22eb", "\\ntriangleright"),
                Z(K, ee, he, "\u22ed", "\\ntrianglerighteq", !0),
                Z(K, ee, he, "\ue018", "\\@nsupseteqq"),
                Z(K, ee, he, "\u228b", "\\supsetneq", !0),
                Z(K, ee, he, "\ue01b", "\\@varsupsetneq"),
                Z(K, ee, he, "\u2acc", "\\supsetneqq", !0),
                Z(K, ee, he, "\ue019", "\\@varsupsetneqq"),
                Z(K, ee, he, "\u22ae", "\\nVdash", !0),
                Z(K, ee, he, "\u2ab5", "\\precneqq", !0),
                Z(K, ee, he, "\u2ab6", "\\succneqq", !0),
                Z(K, ee, he, "\ue016", "\\@nsubseteqq"),
                Z(K, ee, re, "\u22b4", "\\unlhd"),
                Z(K, ee, re, "\u22b5", "\\unrhd"),
                Z(K, ee, he, "\u219a", "\\nleftarrow", !0),
                Z(K, ee, he, "\u219b", "\\nrightarrow", !0),
                ...
                Z(K, ee, he, "\u21ae", "\\nleftrightarrow", !0),
                Z(K, ee, he, "\u21ce", "\\nLeftrightarrow", !0),
                Z(K, ee, he, "\u25b3", "\\vartriangle"),
                Z(K, ee, ce, "\u210f", "\\hslash"),
                Z(K, ee, ce, "\u25bd", "\\triangledown"),
                Z(K, ee, ce, "\u25ca", "\\lozenge"),
                Z(K, ee, ce, "\u24c8", "\\circledS"),
                Z(K, ee, ce, "\xae", "\\circledR"),
                Z(J, ee, ce, "\xae", "\\circledR"),
                Z(K, ee, ce, "\u2221", "\\measuredangle", !0),
                Z(K, ee, ce, "\u2204", "\\nexists"),
                Z(K, ee, ce, "\u2127", "\\mho"),
                Z(K, ee, ce, "\u2132", "\\Finv", !0),
                Z(K, ee, ce, "\u2141", "\\Game", !0),
                Z(K, ee, ce, "\u2035", "\\backprime"),
                Z(K, ee, ce, "\u25b2", "\\blacktriangle"),
                Z(K, ee, ce, "\u25bc", "\\blacktriangledown"),
                Z(K, ee, ce, "\u25a0", "\\blacksquare"),
                Z(K, ee, ce, "\u29eb", "\\blacklozenge"),
                Z(K, ee, ce, "\u2605", "\\bigstar"),
                Z(K, ee, ce, "\u2222", "\\sphericalangle", !0),
                Z(K, ee, ce, "\u2201", "\\complement", !0),
                Z(K, ee, ce, "\xf0", "\\eth", !0),
                Z(J, Q, ce, "\xf0", "\xf0"),
                Z(K, ee, ce, "\u2571", "\\diagup"),
                Z(K, ee, ce, "\u2572", "\\diagdown"),
                ...
                Z(K, ee, ce, "\xa5", "\\yen", !0),
                Z(J, ee, ce, "\xa5", "\\yen", !0),
                Z(K, ee, ce, "\u2713", "\\checkmark", !0),
                Z(J, ee, ce, "\u2713", "\\checkmark"),
                Z(K, ee, ce, "\u2136", "\\beth", !0),
                Z(K, ee, ce, "\u2138", "\\daleth", !0),
                Z(K, ee, ce, "\u2137", "\\gimel", !0),
                Z(K, ee, ce, "\u03dd", "\\digamma", !0),
                Z(K, ee, ce, "\u03f0", "\\varkappa"),
                Z(K, ee, se, "\u250c", "\\@ulcorner", !0),
                Z(K, ee, ne, "\u2510", "\\@urcorner", !0),
                Z(K, ee, se, "\u2514", "\\@llcorner", !0),
                Z(K, ee, ne, "\u2518", "\\@lrcorner", !0),
                Z(K, ee, he, "\u2266", "\\leqq", !0),
                Z(K, ee, he, "\u2a7d", "\\leqslant", !0),
                Z(K, ee, he, "\u2a95", "\\eqslantless", !0),
                Z(K, ee, he, "\u2272", "\\lesssim", !0),
                Z(K, ee, he, "\u2a85", "\\lessapprox", !0),
                Z(K, ee, he, "\u224a", "\\approxeq", !0),
                Z(K, ee, re, "\u22d6", "\\lessdot"),
                Z(K, ee, he, "\u22d8", "\\lll", !0),
                Z(K, ee, he, "\u2276", "\\lessgtr", !0),
                Z(K, ee, he, "\u22da", "\\lesseqgtr", !0),
                Z(K, ee, he, "\u2a8b", "\\lesseqqgtr", !0),
                Z(K, ee, he, "\u2251", "\\doteqdot"),
                Z(K, ee, he, "\u2253", "\\risingdotseq", !0),
                Z(K, ee, he, "\u2252", "\\fallingdotseq", !0),
                Z(K, ee, he, "\u223d", "\\backsim", !0),
                Z(K, ee, he, "\u22cd", "\\backsimeq", !0),
                Z(K, ee, he, "\u2ac5", "\\subseteqq", !0),
                Z(K, ee, he, "\u22d0", "\\Subset", !0),
                Z(K, ee, he, "\u228f", "\\sqsubset", !0),
                Z(K, ee, he, "\u227c", "\\preccurlyeq", !0),
                Z(K, ee, he, "\u22de", "\\curlyeqprec", !0),
                Z(K, ee, he, "\u227e", "\\precsim", !0),
                Z(K, ee, he, "\u2ab7", "\\precapprox", !0),
                Z(K, ee, he, "\u22b2", "\\vartriangleleft"),
                Z(K, ee, he, "\u22b4", "\\trianglelefteq"),
                Z(K, ee, he, "\u22a8", "\\vDash", !0),
                Z(K, ee, he, "\u22aa", "\\Vvdash", !0),
                Z(K, ee, he, "\u2323", "\\smallsmile"),
                Z(K, ee, he, "\u2322", "\\smallfrown"),
                Z(K, ee, he, "\u224f", "\\bumpeq", !0),
                Z(K, ee, he, "\u224e", "\\Bumpeq", !0),
                Z(K, ee, he, "\u2267", "\\geqq", !0),
                Z(K, ee, he, "\u2a7e", "\\geqslant", !0),
                Z(K, ee, he, "\u2a96", "\\eqslantgtr", !0),
                Z(K, ee, he, "\u2273", "\\gtrsim", !0),
                Z(K, ee, he, "\u2a86", "\\gtrapprox", !0),
                Z(K, ee, re, "\u22d7", "\\gtrdot"),
                Z(K, ee, he, "\u22d9", "\\ggg", !0),
                Z(K, ee, he, "\u2277", "\\gtrless", !0),
                Z(K, ee, he, "\u22db", "\\gtreqless", !0),
                Z(K, ee, he, "\u2a8c", "\\gtreqqless", !0),
                Z(K, ee, he, "\u2256", "\\eqcirc", !0),
                Z(K, ee, he, "\u2257", "\\circeq", !0),
                Z(K, ee, he, "\u225c", "\\triangleq", !0),
                Z(K, ee, he, "\u223c", "\\thicksim"),
                Z(K, ee, he, "\u2248", "\\thickapprox"),
                Z(K, ee, he, "\u2ac6", "\\supseteqq", !0),
                Z(K, ee, he, "\u22d1", "\\Supset", !0),
                Z(K, ee, he, "\u2290", "\\sqsupset", !0),
                Z(K, ee, he, "\u227d", "\\succcurlyeq", !0),
                Z(K, ee, he, "\u22df", "\\curlyeqsucc", !0),
                Z(K, ee, he, "\u227f", "\\succsim", !0),
                Z(K, ee, he, "\u2ab8", "\\succapprox", !0),
                Z(K, ee, he, "\u22b3", "\\vartriangleright"),
                Z(K, ee, he, "\u22b5", "\\trianglerighteq"),
                Z(K, ee, he, "\u22a9", "\\Vdash", !0),
                Z(K, ee, he, "\u2223", "\\shortmid"),
                Z(K, ee, he, "\u2225", "\\shortparallel"),
                Z(K, ee, he, "\u226c", "\\between", !0),
                Z(K, ee, he, "\u22d4", "\\pitchfork", !0),
                Z(K, ee, he, "\u221d", "\\varpropto"),
                Z(K, ee, he, "\u25c0", "\\blacktriangleleft"),
                Z(K, ee, he, "\u2234", "\\therefore", !0),
                Z(K, ee, he, "\u220d", "\\backepsilon"),
                Z(K, ee, he, "\u25b6", "\\blacktriangleright"),
                Z(K, ee, he, "\u2235", "\\because", !0),
                Z(K, ee, he, "\u22d8", "\\llless"),
                Z(K, ee, he, "\u22d9", "\\gggtr"),
                Z(K, ee, re, "\u22b2", "\\lhd"),
                ...
                Z(K, ee, he, "\u2251", "\\Doteq", !0),
                Z(K, ee, re, "\u2214", "\\dotplus", !0),
                Z(K, ee, re, "\u2216", "\\smallsetminus"),
                Z(K, ee, re, "\u22d2", "\\Cap", !0),
                Z(K, ee, re, "\u22d3", "\\Cup", !0),
                Z(K, ee, re, "\u2a5e", "\\doublebarwedge", !0),
                Z(K, ee, re, "\u229f", "\\boxminus", !0),
                Z(K, ee, re, "\u229e", "\\boxplus", !0),
                Z(K, ee, re, "\u22c7", "\\divideontimes", !0),
                Z(K, ee, re, "\u22c9", "\\ltimes", !0),
                Z(K, ee, re, "\u22ca", "\\rtimes", !0),
                Z(K, ee, re, "\u22cb", "\\leftthreetimes", !0),
                Z(K, ee, re, "\u22cc", "\\rightthreetimes", !0),
                Z(K, ee, re, "\u22cf", "\\curlywedge", !0),
                Z(K, ee, re, "\u22ce", "\\curlyvee", !0),
                Z(K, ee, re, "\u229d", "\\circleddash", !0),
                Z(K, ee, re, "\u229b", "\\circledast", !0),
                Z(K, ee, re, "\u22c5", "\\centerdot"),
                Z(K, ee, re, "\u22ba", "\\intercal", !0),
                Z(K, ee, re, "\u22d2", "\\doublecap"),
                Z(K, ee, re, "\u22d3", "\\doublecup"),
                Z(K, ee, re, "\u22a0", "\\boxtimes", !0),
                Z(K, ee, he, "\u21e2", "\\dashrightarrow", !0),
                Z(K, ee, he, "\u21e0", "\\dashleftarrow", !0),
                Z(K, ee, he, "\u21c7", "\\leftleftarrows", !0),
                Z(K, ee, he, "\u21c6", "\\leftrightarrows", !0),
                Z(K, ee, he, "\u21da", "\\Lleftarrow", !0),
                Z(K, ee, he, "\u219e", "\\twoheadleftarrow", !0),
                Z(K, ee, he, "\u21a2", "\\leftarrowtail", !0),
                Z(K, ee, he, "\u21ab", "\\looparrowleft", !0),
                Z(K, ee, he, "\u21cb", "\\leftrightharpoons", !0),
                Z(K, ee, he, "\u21b6", "\\curvearrowleft", !0),
                Z(K, ee, he, "\u21ba", "\\circlearrowleft", !0),
                Z(K, ee, he, "\u21b0", "\\Lsh", !0),
                Z(K, ee, he, "\u21c8", "\\upuparrows", !0),
                Z(K, ee, he, "\u21bf", "\\upharpoonleft", !0),
                Z(K, ee, he, "\u21c3", "\\downharpoonleft", !0),
                Z(K, ee, he, "\u22b8", "\\multimap", !0),
                Z(K, ee, he, "\u21ad", "\\leftrightsquigarrow", !0),
                Z(K, ee, he, "\u21c9", "\\rightrightarrows", !0),
                Z(K, ee, he, "\u21c4", "\\rightleftarrows", !0),
                Z(K, ee, he, "\u21a0", "\\twoheadrightarrow", !0),
                Z(K, ee, he, "\u21a3", "\\rightarrowtail", !0),
                Z(K, ee, he, "\u21ac", "\\looparrowright", !0),
                Z(K, ee, he, "\u21b7", "\\curvearrowright", !0),
                Z(K, ee, he, "\u21bb", "\\circlearrowright", !0),
                Z(K, ee, he, "\u21b1", "\\Rsh", !0),
                Z(K, ee, he, "\u21ca", "\\downdownarrows", !0),
                Z(K, ee, he, "\u21be", "\\upharpoonright", !0),
                Z(K, ee, he, "\u21c2", "\\downharpoonright", !0),
                Z(K, ee, he, "\u21dd", "\\rightsquigarrow", !0),
                Z(K, ee, he, "\u21dd", "\\leadsto"),
                Z(K, ee, he, "\u21db", "\\Rrightarrow", !0),
                Z(K, ee, he, "\u21be", "\\restriction"),
                Z(K, Q, ce, "\u2018", "`"),
                Z(K, Q, ce, "$", "\\$"),
                Z(J, Q, ce, "$", "\\$"),
                Z(J, Q, ce, "$", "\\textdollar"),
                ...
                Z(K, Q, ce, "\u22a5", "\\bot"),
                Z(K, Q, ce, "\u2205", "\\emptyset"),
                Z(K, ee, ce, "\u2205", "\\varnothing"),
                Z(K, Q, ie, "\u03b1", "\\alpha", !0),
                Z(K, Q, ie, "\u03b2", "\\beta", !0),
                Z(K, Q, ie, "\u03b3", "\\gamma", !0),
                Z(K, Q, ie, "\u03b4", "\\delta", !0),
                Z(K, Q, ie, "\u03f5", "\\epsilon", !0),
                Z(K, Q, ie, "\u03b6", "\\zeta", !0),
                Z(K, Q, ie, "\u03b7", "\\eta", !0),
                Z(K, Q, ie, "\u03b8", "\\theta", !0),
                Z(K, Q, ie, "\u03b9", "\\iota", !0),
                ...
                Z(K, Q, ie, "\u03bd", "\\nu", !0),
                Z(K, Q, ie, "\u03be", "\\xi", !0),
                Z(K, Q, ie, "\u03bf", "\\omicron", !0),
                Z(K, Q, ie, "\u03c0", "\\pi", !0),
                Z(K, Q, ie, "\u03c1", "\\rho", !0),
                Z(K, Q, ie, "\u03c3", "\\sigma", !0),
                Z(K, Q, ie, "\u03c4", "\\tau", !0),
                Z(K, Q, ie, "\u03c5", "\\upsilon", !0),
                Z(K, Q, ie, "\u03d5", "\\phi", !0),
                Z(K, Q, ie, "\u03c7", "\\chi", !0),
                Z(K, Q, ie, "\u03c8", "\\psi", !0),
                Z(K, Q, ie, "\u03c9", "\\omega", !0),
                Z(K, Q, ie, "\u03b5", "\\varepsilon", !0),
                Z(K, Q, ie, "\u03d1", "\\vartheta", !0),
                Z(K, Q, ie, "\u03d6", "\\varpi", !0),
                Z(K, Q, ie, "\u03f1", "\\varrho", !0),
                Z(K, Q, ie, "\u03c2", "\\varsigma", !0),
                Z(K, Q, ie, "\u03c6", "\\varphi", !0),
                Z(K, Q, re, "\u2217", "*"),
                Z(K, Q, re, "+", "+"),
                Z(K, Q, re, "\u2212", "-"),
                ...
                Z(J, Q, me, "\xa0", "\\nobreakspace"),
                Z(K, Q, me, null, "\\nobreak"),
                Z(K, Q, me, null, "\\allowbreak"),
                Z(K, Q, le, ",", ","),
                Z(K, Q, le, ";", ";"),
                Z(K, ee, re, "\u22bc", "\\barwedge", !0),
                Z(K, ee, re, "\u22bb", "\\veebar", !0),
                Z(K, Q, re, "\u2299", "\\odot", !0),
                Z(K, Q, re, "\u2295", "\\oplus", !0),
                Z(K, Q, re, "\u2297", "\\otimes", !0),
                Z(K, Q, ce, "\u2202", "\\partial", !0),
                Z(K, Q, re, "\u2298", "\\oslash", !0),
                Z(K, ee, re, "\u229a", "\\circledcirc", !0),
                Z(K, ee, re, "\u22a1", "\\boxdot", !0),
                Z(K, Q, re, "\u25b3", "\\bigtriangleup"),
                Z(K, Q, re, "\u25bd", "\\bigtriangledown"),
                Z(K, Q, re, "\u2020", "\\dagger"),
                Z(K, Q, re, "\u22c4", "\\diamond"),
                Z(K, Q, re, "\u22c6", "\\star"),
                Z(K, Q, re, "\u25c3", "\\triangleleft"),
                Z(K, Q, re, "\u25b9", "\\triangleright"),
                Z(K, Q, se, "{", "\\{"),
                Z(J, Q, ce, "{", "\\{"),
                Z(J, Q, ce, "{", "\\textbraceleft"),
                Z(K, Q, ne, "}", "\\}"),
                Z(J, Q, ce, "}", "\\}"),
                Z(J, Q, ce, "}", "\\textbraceright"),
                Z(K, Q, se, "{", "\\lbrace"),
                Z(K, Q, ne, "}", "\\rbrace"),
                Z(K, Q, se, "[", "\\lbrack", !0),
                Z(J, Q, ce, "[", "\\lbrack", !0),
                ...
                Z(K, Q, ce, "\u2225", "\\Vert"),
                Z(J, Q, ce, "\u2225", "\\textbardbl"),
                Z(J, Q, ce, "~", "\\textasciitilde"),
                Z(J, Q, ce, "\\", "\\textbackslash"),
                Z(J, Q, ce, "^", "\\textasciicircum"),
                Z(K, Q, he, "\u2191", "\\uparrow", !0),
                Z(K, Q, he, "\u21d1", "\\Uparrow", !0),
                Z(K, Q, he, "\u2193", "\\downarrow", !0),
                Z(K, Q, he, "\u21d3", "\\Downarrow", !0),
                Z(K, Q, he, "\u2195", "\\updownarrow", !0),
                Z(K, Q, he, "\u21d5", "\\Updownarrow", !0),
                Z(K, Q, oe, "\u2210", "\\coprod"),
                Z(K, Q, oe, "\u22c1", "\\bigvee"),
                Z(K, Q, oe, "\u22c0", "\\bigwedge"),
                ...
                Z(K, Q, oe, "\u2a06", "\\bigsqcup"),
                Z(K, Q, oe, "\u222b", "\\smallint"),
                Z(J, Q, ae, "\u2026", "\\textellipsis"),
                Z(K, Q, ae, "\u2026", "\\mathellipsis"),
                Z(J, Q, ae, "\u2026", "\\ldots", !0),
                Z(K, Q, ae, "\u2026", "\\ldots", !0),
                Z(K, Q, ae, "\u22ef", "\\@cdots", !0),
                Z(K, Q, ae, "\u22f1", "\\ddots", !0),
              ...
              Z(J, Q, ce, "\u2013", "--", !0),
                ...
                Z(J, Q, ce, "\u2014", "\\textemdash"),
                Z(J, Q, ce, "\u2018", "`", !0),
                Z(J, Q, ce, "\u2018", "\\textquoteleft"),
                Z(J, Q, ce, "\u2019", "'", !0),
                Z(J, Q, ce, "\u2019", "\\textquoteright"),
                Z(J, Q, ce, "\u201c", "``", !0),
                Z(J, Q, ce, "\u201c", "\\textquotedblleft"),
                Z(J, Q, ce, "\u201d", "''", !0),
                Z(J, Q, ce, "\u201d", "\\textquotedblright"),
                Z(K, Q, ce, "\xb0", "\\degree", !0),
                Z(J, Q, ce, "\xb0", "\\degree"),
                Z(J, Q, ce, "\xb0", "\\textdegree", !0),
                Z(K, Q, ce, "\xa3", "\\pounds"),
                Z(K, Q, ce, "\xa3", "\\mathsterling", !0),
                Z(J, Q, ce, "\xa3", "\\pounds"),
                Z(J, Q, ce, "\xa3", "\\textsterling", !0),
                Z(K, ee, ce, "\u2720", "\\maltese"),
                Z(J, ee, ce, "\u2720", "\\maltese");
              ...
              for (var ke = "", Se = 0; Se < ye.length; Se++) {
                var Me = ye.charAt(Se);
                Z(K, Q, ie, Me, (ke = String.fromCharCode(55349, 56320 + Se))),
                  Z(J, Q, ce, Me, ke),
                  Z(
                    K,
                    Q,
                    ie,
                    Me,
                    (ke = String.fromCharCode(55349, 56372 + Se))
                  ),
                  Z(J, Q, ce, Me, ke),
                  Z(
                    K,
                    ...
                    ie,
                    Me,
                    (ke = String.fromCharCode(55349, 56424 + Se))
                  ),
                  Z(J, Q, ce, Me, ke),
                  Z(
                    K,
                    ...
                    ie,
                    Me,
                    (ke = String.fromCharCode(55349, 56580 + Se))
                  ),
                  Z(J, Q, ce, Me, ke),
                  Z(
                    K,
                    ...
                    ie,
                    Me,
                    (ke = String.fromCharCode(55349, 56736 + Se))
                  ),
                  Z(J, Q, ce, Me, ke),
                  Z(
                    K,
                    ...
                    ie,
                    Me,
                    (ke = String.fromCharCode(55349, 56788 + Se))
                  ),
                  Z(J, Q, ce, Me, ke),
                  Z(
                    K,
                    ...
                    ie,
                    Me,
                    (ke = String.fromCharCode(55349, 56840 + Se))
                  ),
                  Z(J, Q, ce, Me, ke),
                  Z(
                    K,
                    ...
                    ie,
                    Me,
                    (ke = String.fromCharCode(55349, 56944 + Se))
                  ),
                  Z(J, Q, ce, Me, ke),
                  Se < 26 &&
                    (Z(
                      ...
                      ie,
                      Me,
                      (ke = String.fromCharCode(55349, 56632 + Se))
                    ),
                    Z(J, Q, ce, Me, ke),
                    Z(
                      K,
                      ...
                      ie,
                      Me,
                      (ke = String.fromCharCode(55349, 56476 + Se))
                    ),
                    Z(J, Q, ce, Me, ke));
              }
              Z(K, Q, ie, "k", (ke = String.fromCharCode(55349, 56668))),
                Z(J, Q, ce, "k", ke);
              for (var ze = 0; ze < 10; ze++) {
                var Ae = ze.toString();
                Z(K, Q, ie, Ae, (ke = String.fromCharCode(55349, 57294 + ze))),
                  Z(J, Q, ce, Ae, ke),
                  Z(
                    K,
                    Q,
                    ie,
                    Ae,
                    (ke = String.fromCharCode(55349, 57314 + ze))
                  ),
                  Z(J, Q, ce, Ae, ke),
                  Z(
                    K,
                    ...
                    ie,
                    Ae,
                    (ke = String.fromCharCode(55349, 57324 + ze))
                  ),
                  Z(J, Q, ce, Ae, ke),
                  Z(
                    K,
                    ...
                    ie,
                    Ae,
                    (ke = String.fromCharCode(55349, 57334 + ze))
                  ),
                  Z(J, Q, ce, Ae, ke);
              }
              for (
                var Te = "\xc7\xd0\xde\xe7\xfe", Be = 0;
                Be < Te.length;
                Be++
              ) {
                var Ce = Te.charAt(Be);
                ...
                Ee = (function () {
                  function e(t) {
                    (this.style = void 0),
                      ...
                      (this.sizeMultiplier = Oe[this.size - 1]),
                  ...
                  return (
                    ...
                    (t.havingStyle = function (e) {
                      return this.style === e
                        ? this
                        : this.extend({ style: e, size: Re(this.textSize, e) });
                    }),
                        ...
                        this._fontMetrics ||
                          (this._fontMetrics = (function (e) {
                            ...
                            if (!_[(t = e >= 5 ? 0 : e >= 3 ? 1 : 2)]) {
                              var r = (_[t] = { cssEmPerMu: U.quad[t] / 18 });
                              for (var n in U)
                                U.hasOwnProperty(n) && (r[n] = U[n][t]);
                            }
                            return _[t];
                          })(this.size)),
                        this._fontMetrics
              ...
              var Le = Ee,
                ...
                He = function (e) {
                  return (
                    ...
                    e in Pe || e in De || "ex" === e
                  );
                },
                Fe = function (e, t) {
                  var r;
                  if (e.unit in Pe)
                    r = Pe[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
                ...
                Ve = function (e, t, r) {
                  return (
                    $[r][e] && $[r][e].replace && (e = $[r][e].replace),
                    { value: e, metrics: Y(e, t, r) }
                  );
                },
                Ue = function (e, t, r, n, a) {
                  ...
                  if (((e = o.value), s)) {
                    ...
                    ("text" === r || (n && "mathit" === n.font)) && (l = 0),
                      (i = new L(e, s.height, s.depth, l, s.skew, s.width, a));
                  } else
                    "undefined" !== typeof console &&
                      console.warn(
                ...
                Ke = {
                          ...
                          if ("individualShift" === e.positionType) {
                            for (
                              ...
                              var o = -t[i].shift - a - t[i].elem.depth,
                                s =
                                  o -
                                  (t[i - 1].elem.height + t[i - 1].elem.depth);
                              (a += o),
                  ...
                  makeOrd: function (e, t, r) {
                    ...
                    if (l) {
                      ...
                      if (Ve(a, u, n).metrics)
                        return Ue(a, u, n, t, i.concat(p));
                      if (
                        ue.hasOwnProperty(a) &&
                        "Typewriter" === u.substr(0, 10)
                      ) {
                        for (var f = [], g = 0; g < a.length; g++)
                          f.push(Ue(a[g], u, n, t, i.concat(p)));
                        return Xe(f);
                      }
                    }
                    if ("mathord" === r)
                    ...
                    if ("textord" === r) {
                      ...
                      if ("main" !== v && v) {
                        ...
                        return Ue(
                          ...
                          n,
                          t,
                          i.concat(y, t.fontWeight, t.fontShape)
                        );
                      }
              ...
              var lt = function (e) {
                ...
                gt = function (e) {
                  return e instanceof T ||
                    e instanceof O ||
                    (e instanceof I && e.hasClass("enclosing"))
                    ? e
                    : null;
                },
                vt = function e(t, r) {
                ...
                bt = function (e, t) {
                  return e
                    ? (t && (e = vt(e, t)), pt[e.classes[0]] || null)
                    : null;
                },
                yt = function (e, t) {
                ...
                for (
                  ...
                  if (
                    ...
                    a[s].hasClass("newline") &&
                      (o.pop(),
                      o.length > 0 && (i.push(wt(o, t)), (o = [])),
                      i.push(a[s]));
                o.length > 0 && i.push(wt(o, t)),
                  r && (((n = wt(dt(r, t, !0))).classes = ["tag"]), i.push(n));
              ...
              var Rt = function (e) {
                ...
                Lt = function (e, t, r) {
                  var n,
                    a = Rt(r);
                  if ("mathml" === r.output)
                    return Ot(e, t, a, r.displayMode, !0);
                  if ("html" === r.output) {
                    var i = kt(e, a);
                ...
                Ht = function (e, t, r, n) {
                  ...
                  if (/fbox|color/.test(t)) {
                    if (
                      ((a = Ke.makeSpan(["stretchy", t], [], n)), "fbox" === t)
                    ) {
                    ...
                    var l = new P(s, { width: "100%", height: i + "em" });
              ...
              function Yt(e) {
                return e && ("atom" === e.type || X.hasOwnProperty(e.type))
                  ? e
                  : null;
              }
              var _t = function (e, t) {
                  ...
                  var l,
                    h = Math.min(i.height, t.fontMetrics().xHeight);
                  if (n.isStretchy)
                    (l = Vt(n, t)),
                      (l = Ke.makeVList(
                        {
                    ...
                    var m, u;
                    "\\vec" === n.label
                      ? ((m = Ke.staticSvg("vec", t)), (u = Ke.svgData.vec[1]))
                      : (((m = F(
                          (m = Ke.makeOrd(
              ...
              ot({
                ...
                htmlBuilder: function (e, t) {
                  ...
                  i.classes.push("x-arrow-pad"),
                    e.below &&
                      ...
                      (r = Ke.wrapFragment(xt(e.below, a, t), t)).classes.push(
                        "x-arrow-pad"
                      ));
                  var o,
                    s = Vt(e, t),
                ...
                ot({
                  ...
                  handler: function (e, t) {
                    for (
                      var r = e.parser,
                        n = Ut(t[0], "ordgroup").body,
                        a = "",
                        i = 0;
                      i < n.length;
                      i++
                    )
                      a += Ut(n[i], "textord").text;
                    var s = parseInt(a);
                    if (isNaN(s))
              ...
              ot({
                ...
                handler: function (e, t) {
                  var r = e.parser,
                    ...
                    a = t[1];
                  return { type: "color", mode: r.mode, color: n, body: lt(a) };
                },
                htmlBuilder: $t,
                mathmlBuilder: Zt,
              }),
                  ...
                  htmlBuilder: function (e, t) {
                    ...
                    return (
                      e.newLine &&
                        ...
                        e.size && (r.style.marginTop = Fe(e.size, t) + "em")),
                      r
                    );
                  },
                  mathmlBuilder: function (e, t) {
                    ...
                    return (
                      e.newLine &&
                        ...
                        e.size &&
                          r.setAttribute("height", Fe(e.size, t) + "em")),
                      r
                    );
                  },
                });
                ...
                ot({
                  ...
                  handler: function (e) {
                    ...
                    for (
                      ...
                      if (1 !== (n = t.gullet.consumeArgs(1)[0]).length)
                        throw new o(
                    ...
                    return (
                      ("\\edef" !== r && "\\xdef" !== r) ||
                        (n = t.gullet.expandTokens(n)).reverse(),
                      t.gullet.macros.set(
                        a,
                        { tokens: n, numArgs: i },
                        r === Kt[r]
              ...
              var er = function (e, t, r) {
                ...
                or = function (e, t, r, n, a, i) {
                  ...
                  if (("\u239c" !== l && "\u239f" !== l) || 0 !== k)
                    ...
                    var I =
                        "\u239c" === l ? "leftParenInner" : "rightParenInner",
                      O = Ke.staticSvg(I, n);
                  ...
                  return tr(
                    Ke.makeSpan(["delimsizing", "mult"], [E], R),
                    w.TEXT,
                    n,
                    i
                  );
                ...
                br = function (e, t, r, n, a, i) {
                  ...
                  "<" === e || "\\lt" === e || "\u27e8" === e
                    ...
                    : (">" !== e && "\\gt" !== e && "\u27e9" !== e) ||
                      (e = "\\rangle"),
                    (o = c.contains(cr, e) ? pr : c.contains(hr, e) ? fr : dr);
                  var s = vr(e, t, o, n);
                  return "small" === s.type
                  ...
                  return (
                    "small" === i.type
                      ...
                      : ((l = e + s + sr),
                        ...
                        ((r = lr("sqrtTall", l, m, s, t)).style.minWidth =
                          "0.742em"),
                        (n = 1.056)),
                    (r.height = h),
                    (r.style.height = l + "em"),
                ...
                xr = function (e, t, r, n, a) {
                  if (
                    ("<" === e || "\\lt" === e || "\u27e8" === e
                      ...
                      : (">" !== e && "\\gt" !== e && "\u27e9" !== e) ||
                        (e = "\\rangle"),
                    c.contains(hr, e) || c.contains(cr, e))
                  )
                    return nr(e, t, !1, r, n, a);
              ...
              ot({
                ...
                htmlBuilder: function (e, t) {
                  return "." === e.delim
                    ...
                    : xr(e.delim, e.size, t, e.mode, [e.mclass]);
                },
              ...
              var Tr = function (e, t) {
                  var r,
                    n,
                    a = Ke.wrapFragment(xt(e.body, t), t),
                    i = e.label.substr(1),
                    o = t.sizeMultiplier,
                    s = 0,
                  ...
                  if ("sout" === i)
                    ...
                    /box/.test(i)
                      ? ((m = Math.max(
                        ...
                        (h =
                          t.fontMetrics().fboxsep + ("colorbox" === i ? 0 : m)))
                      : (h = l ? 0.2 : 0),
                      (r = Ht(a, i, h, t)),
              ...
              function Ir(e, t, r) {
                ...
                for (p.push(Nr(e)); ; ) {
                  ...
                  e.gullet.endGroup(),
                    e.gullet.beginGroup(),
                    (d = { type: "ordgroup", mode: e.mode, body: d }),
                    r &&
                      (d = {
                        type: "styling",
                        mode: e.mode,
              ...
              var Rr = function (e, t) {
                  ...
                  for (n = 0, q = 0; n < s || q < I.length; ++n, ++q) {
                    for (var R = I[q] || {}, E = !0; "separator" === R.type; ) {
                      if (
                        (E ||
                          (((C = Ke.makeSpan(["arraycolsep"], [])).style.width =
                  ...
                  if (((l = Ke.makeSpan(["mtable"], O)), h.length > 0)) {
                    for (
                      var G = Ke.makeLineSpan("hline", t, m),
                        Y = Ke.makeLineSpan("hdashline", t, m),
                ...
                Er = { c: "center ", l: "left ", r: "right " },
                Lr = function (e, t) {
                  var r = new At.MathNode(
                      "mtable",
                  ...
                  if ("align" === e.colSeparationType) {
                    for (var u = e.cols || [], p = "", d = 1; d < u.length; d++)
                      p += d % 2 ? "0em " : "1em ";
                  ...
                  return (
                    ...
                    "" !== a &&
                      (r = new At.MathNode("menclose", [r])).setAttribute(
                        "notation",
                        a.trim()
                      ),
                    e.arraystretch &&
                ...
                Pr = function (e, t) {
                  var r,
                    n = [],
                    a = Ir(e.parser, { cols: n, addJot: !0 }, "display"),
                    i = 0,
                    s = { type: "ordgroup", mode: e.mode, body: [] };
                  if (t[0] && "ordgroup" === t[0].type) {
                    for (var l = "", h = 0; h < t[0].body.length; h++)
                      l += Ut(t[0].body[h], "textord").text;
                    (r = Number(l)), (i = 2 * r);
                  }
                  var m = !i;
              ...
              qr({
                ...
                handler: function (e, t) {
                  var r = {
                    cols: (Yt(t[0]) ? [t[0]] : Ut(t[0], "ordgroup").body).map(
                      function (e) {
                        var t = Gt(e).text;
                        if (-1 !== "lcr".indexOf(t))
                ...
                qr({
                  ...
                  props: { numArgs: 0 },
                  handler: function (e) {
                    var t = Ir(e.parser, { arraystretch: 0.5 }, "script");
                ...
                qr({
                  ...
                  props: { numArgs: 1 },
                  handler: function (e, t) {
                    var r = (Yt(t[0]) ? [t[0]] : Ut(t[0], "ordgroup").body).map(
                      function (e) {
                        var t = Gt(e).text;
                        if (-1 !== "lc".indexOf(t))
                          return { type: "align", align: t };
                    ...
                    if (
                      (n = Ir(e.parser, n, "script")).body.length > 0 &&
                      n.body[0].length > 1
                    )
                      throw new o("{subarray} can contain only one column");
                    return n;
              ...
              function Vr(e, t) {
                ...
                return "minner" === e.mclass
                  ? At.newDocumentFragment(n)
                  : ("mord" === e.mclass
                      ? e.isCharacterBox
                        ? ((r = n[0]).type = "mi")
                        : (r = new At.MathNode("mi", n))
                      : (e.isCharacterBox
                          ? ((r = n[0]).type = "mo")
                          : (r = new At.MathNode("mo", n)),
                        "mbin" === e.mclass
              ...
              var Wr = function (e, t) {
                ...
                Xr = function (e, t) {
                  ...
                  if (
                    ...
                    n.size === w.DISPLAY.size || "display" === e.size
                  ...
                  return (
                    ...
                    (v =
                      null == e.leftDelim
                        ? yt(t, ["mopen"])
                        : wr(e.leftDelim, g, !0, t.havingStyle(n), e.mode, [
                            "mopen",
                          ])),
                    (b = e.continued
                      ? Ke.makeSpan([])
                      : null == e.rightDelim
                      ? yt(t, ["mclose"])
                      : wr(e.rightDelim, g, !0, t.havingStyle(n), e.mode, [
                          "mclose",
                        ])),
                    Ke.makeSpan(
              ...
              ot({
                ...
                handler: function (e, t) {
                  var r,
                    ...
                    i = t[5],
                    o =
                      "atom" === t[0].type && "open" === t[0].family
                        ? Zr(t[0].text)
                        : null,
                    s =
                      "atom" === t[1].type && "close" === t[1].family
                        ? Zr(t[1].text)
                        : null,
                    l = Ut(t[2], "size"),
                    h = null;
              ...
              var Kr = function (e, t) {
                ...
                "supsub" === e.type
                  ? ((r = e.sup
                      ? xt(e.sup, t.havingStyle(a.sup()), t)
                      : xt(e.sub, t.havingStyle(a.sub()), t)),
                    (n = Ut(e.base, "horizBrace")))
                  : (n = Ut(e, "horizBrace"));
                var i,
                  o = xt(n.base, t.havingBaseStyle(w.DISPLAY)),
                  s = Vt(n, t);
                if (
                  (n.isOver
                    ? (i = Ke.makeVList(
              ...
              ot({
                ...
                ot({
                  ...
                  handler: function (e, t) {
                    ...
                    return r.settings.isTrusted({ command: "\\href", url: a })
                      ? { type: "href", mode: r.mode, href: a, body: lt(n) }
                ...
                ot({
                  ...
                  handler: function (e, t) {
                    ...
                    return { type: "href", mode: r.mode, href: n, body: lt(s) };
                  },
                }),
                ot({
                  type: "html",
              ...
              ot({
                ...
                mathmlBuilder: function (e, t) {
                  ...
                  if (
                    (e.totalheight.number > 0 &&
                      ((a = (a = Fe(e.totalheight, t) - n).toFixed(2)),
                ...
                ot({
                  ...
                  htmlBuilder: function (e, t) {
                    var r;
                    "clap" === e.alignment
                      ? ((r = Ke.makeSpan([], [xt(e.body, t)])),
                        (r = Ke.makeSpan(["inner"], [r], t)))
                      : (r = Ke.makeSpan(["inner"], [xt(e.body, t)]));
                ...
                rn = function (e, t) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      (o = Ke.makeSymbol(a.name, h, "math", t, [
                        "mop",
                        "op-symbol",
                        l ? "large-op" : "small-op",
                      ])),
                    ...
                    var d = dt(a.body, t, !0);
                    1 === d.length && d[0] instanceof L
                      ? ((o = d[0]).classes[0] = "mop")
                      : (o = Ke.makeSpan(["mop"], Ke.tryCombineChars(d), t));
                  } else {
                  ...
                  return (
                    (o instanceof L ||
                      ...
                      !a.suppressBaseShift &&
                      ((v =
                        (o.height - o.depth) / 2 - t.fontMetrics().axisHeight),
                      (b = o.italic)),
                    i
                      ? en(o, r, n, t, s, b, v)
                      : (v &&
              ...
              ot({
                ...
                st({
                  ...
                  htmlBuilder: function (e, t) {
                    return e.semisimple
                      ? Ke.makeFragment(dt(e.body, t, !1))
                      : Ke.makeSpan(["mord"], dt(e.body, t, !0), t);
                  },
                  mathmlBuilder: function (e, t) {
                ...
                ot({
                  ...
                  handler: function (e, t) {
                    var r = e.parser,
                      n = t[0];
                    return { type: "phantom", mode: r.mode, body: lt(n) };
                  },
                  htmlBuilder: function (e, t) {
                ...
                ot({
                  ...
                  mathmlBuilder: function (e, t) {
                    var r = e.body,
                      n = e.index;
                    return n
                      ? new At.MathNode("mroot", [It(r, t), It(n, t)])
              ...
              var cn = { mi: "italic", mn: "normal", mtext: "normal" };
              st({
                type: "mathord",
                htmlBuilder: function (e, t) {
                ...
                mathmlBuilder: function (e, t) {
                  var r = new At.MathNode("mi", [Tt(e.text, e.mode, t)]),
                    n = Ct(e, t) || "italic";
                  return (
                    n !== cn[r.type] && r.setAttribute("mathvariant", n), r
                  );
                },
              }),
                st({
                  ...
                  mathmlBuilder: function (e, t) {
                    ...
                    return (
                      ...
                      a !== cn[r.type] && r.setAttribute("mathvariant", a),
                      r
                    );
                  },
                });
              ...
              st({
                ...
                htmlBuilder: function (e, t) {
                  ...
                  if (un.hasOwnProperty(e.text))
                    return Ke.makeSpan(["mspace", un[e.text]], [], t);
              ...
              st({
                ...
                mathmlBuilder: function (e, t) {
                  var r = new At.MathNode("mtable", [
                    new At.MathNode("mtr", [
                      dn(),
                      new At.MathNode("mtd", [Nt(e.body, t)]),
                      dn(),
                      new At.MathNode("mtd", [Nt(e.tag, t)]),
                    ]),
                  ]);
              ...
              var fn = {
                ...
                gn = { "\\textbf": "textbf", "\\textmd": "textmd" },
                vn = { "\\textit": "textit", "\\textup": "textup" },
                bn = function (e, t) {
                  var r = e.font;
                  return r
                    ? fn[r]
                      ? t.withTextFontFamily(fn[r])
                      : gn[r]
                      ? t.withTextFontWeight(gn[r])
                      : t.withTextFontShape(vn[r])
                    : t;
                };
              ot({
                type: "text",
                ...
                handler: function (e, t) {
                  var r = e.parser,
                    n = e.funcName,
                    a = t[0];
                  return { type: "text", mode: r.mode, body: lt(a), font: n };
                },
                htmlBuilder: function (e, t) {
                  var r = bn(e, t),
                    n = dt(e.body, r, !0);
                ...
                Sn = (function () {
                  ...
                  return (
                    ...
                    (t.lex = function () {
                      ...
                      if (t === e.length)
                        return new a("EOF", new n(this, t, t));
                      var r = this.tokenRegex.exec(e);
                      if (null === r || r.index !== t)
                        throw new o(
                          "Unexpected character: '" + e[t] + "'",
                          new a(e[t], new n(this, t, t + 1))
                        );
                      var i = r[2] || " ";
                      ...
                      return (
                        l && (i = l[1]),
                        new a(i, new n(this, t, this.tokenRegex.lastIndex))
                      );
                    }),
                    e
                  );
              ...
              Tn("\\char", function (e) {
                ...
                if (t) {
                  if (null == (n = Bn[r.text]) || n >= t)
                    throw new o("Invalid base-" + t + " digit " + r.text);
                  for (var a; null != (a = Bn[e.future().text]) && a < t; )
                    (n *= t), (n += a), e.popToken();
                }
                return "\\@char{" + n + "}";
              });
              var Cn = function (e, t, r) {
                ...
                return e.macros.set(a, { tokens: n, numArgs: s }), "";
              };
              ...
              Tn("\\dots", function (e) {
                ...
                return (
                  r in qn
                    ...
                    : ("\\not" === r.substr(0, 4) ||
                        (r in $.math &&
                          c.contains(["bin", "rel"], $.math[r].group))) &&
                      (t = "\\dotsb"),
                  t
                );
              });
                ...
                Rn = (function () {
                  function e(e, t, r) {
                    (this.settings = void 0),
                      ...
                      this.feed(e),
                      (this.macros = new Mn(An, t.macros)),
                      (this.mode = r),
                      (this.stack = []);
                  }
                  var t = e.prototype;
                      ...
                      if ("string" === typeof r) {
                        ...
                        if (-1 !== r.indexOf("#"))
                          for (
                            ...
                            ++n;
                        for (
                          var i = new Sn(r, this.settings), o = [], s = i.lex();
                          "EOF" !== s.text;
                ...
                Pn = (function () {
                  function e(e, t) {
                    (this.mode = void 0),
                      ...
                      (this.mode = "math"),
                      (this.gullet = new Rn(e, t, this.mode)),
                      (this.settings = t),
                  ...
                  return (
                    ...
                    (t.parseRegexGroup = function (e, t) {
                      ...
                      for (
                        ...
                        "EOF" !== (n = this.fetch()).text && e.test(s + n.text);

                      )
                        (s += (i = n).text), this.consume();
                      if ("" === s)
                        throw new o("Invalid " + t + ": '" + a.text + "'", a);
                    ...
                    (t.parseSizeGroup = function (e) {
                      ...
                      if (!He(a))
                        throw new o("Invalid unit: '" + a.unit + "'", t);
                      return {
                        type: "size",
                        mode: this.mode,
                        value: a,
                    ...
                    (t.parseSymbol = function () {
                      ...
                      if (
                        ...
                        if (W.hasOwnProperty(h)) {
                          ...
                          l = { type: h, mode: this.mode, loc: m, text: t };
                        i = l;
                      } else {
                      ...
                      if ((this.consume(), s))
                        for (var u = 0; u < s[0].length; u++) {
                          var p = s[0][u];
                          if (!En[p])
                            throw new o("Unknown accent ' " + p + "'", e);
