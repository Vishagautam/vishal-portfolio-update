  ...
  [7],
  {
    ...
    IKlv: function (e, t, n) {
      ...
      function se(e) {
        ...
        return (
          console.error(n),
          Y.loadPage("/_error").then(function (r) {
            var a = r.page,
              o = r.styleSheets,
              i = he(t),
              u = {
                ...
                AppTree: i,
                router: Z,
                ctx: { err: n, pathname: I, query: D, asPath: z, AppTree: i },
              };
      ...
      var ve,
        he = function (e) {
          return function (t) {
            var n = (0, m.default)({}, t, { Component: re, err: F, router: Z });
            return v.default.createElement(
              me,
              null,
              v.default.createElement(e, n)
            );
          };
        };
      function ye(e) {
        ...
        var i = (0, m.default)({}, r, { Component: n, err: a, router: Z });
        ve = i;
        var u,
          c = !1,
                ...
                if (o && !c) {
                  for (
                    var t = new Set(
                      ...
                      n = L(document.querySelectorAll("style[data-n-href]")),
                      r = n.map(function (e) {
                  ...
                  i &&
                    o.forEach(function (e) {
                      ...
                      n &&
                        (i.parentNode.insertBefore(n, i.nextSibling), (i = n));
                    }),
        ...
        return (
          ...
          (l = v.default.createElement(v.default.StrictMode, null, d)),
          (f = ne),
          x.ST && performance.mark("beforeRender"),
          le
            ? (h.default.hydrate(l, f, fe), (le = !1))
            : h.default.render(l, f, de),
          s
        );
      }
      function ge(e) {
    ...
    bGXG: function (e, t, n) {
      ...
      function u(e) {
        ...
        (navigator.sendBeacon && navigator.sendBeacon(a, n)) ||
          fetch(a, {
            body: n,
            method: "POST",
            credentials: "omit",
            ...
            },
            {
              ...
              value: function (e, t, n, r) {
                var a = this,
                  ...
                  h = function (e) {
                    var t = (0, c.default)(
                      (0, f.removePathTrailingSlash)((0, u.addLocale)(e, r)),
                      ".json"
                    );
